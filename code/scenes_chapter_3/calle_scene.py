...
class CalleScene(Scene):
    def __init__(self, screen, player):
        ...
        # Suponiendo que el asset de la calle es "calle.png"
    ...
    def update(self, dt):
        ...
        # Nueva transición: si el jugador choca con la zona de reingreso a la sala
        door_calle_to_sala = pygame.Rect(490, 250, 10, 250)
        if self.player.rect.colliderect(door_calle_to_sala):
            # Posicionar al jugador en la entrada de la sala (ajusta según convenga)
