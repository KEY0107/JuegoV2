...
class InteriorEdificioI2(Scene):
        ...
        for event in events:
            if event.type == pygame.KEYDOWN and event.key == pygame.K_e:
                if self.note_active:
                    ...
                    InteriorEdificioI2.note_taken_flag = True
    ...
    def update(self, dt):
        ...
        # Transición: regresar al pasillo segundo piso
    ...
    def get_hud_visibility(self):
        # Ocultar el HUD mientras se muestra el diálogo de la nota
        if self.note_active:
            return False
        return True
    ...
    def render(self):
        ...
        if self.note_visible and not InteriorEdificioI2.note_taken_flag:
            world_surface.blit(
                self.note.image,
